...
class AsetController extends Controller
{
    ...
    public function show($id, $type)
    {
        ...
        if($type == 1) {
          $name = 'Komputer Riba';
          $list = DB::table('aset_nb')->select('nb_nama as nama', 'nb_sykt as sykt', 'nb_title as title')->where('id', $id)->first();
        ...
        if($type == 2) {
          $name = 'Projektor LCD';
          $list = DB::table('aset_lcd')->select('lcd_nama as nama', 'lcd_sykt as sykt', 'lcd_title as title')->where('id', $id)->first();
        ...
        if($type == 3) {
          $name = 'Pencetak';
          $list = DB::table('aset_print')->select('print_nama as nama', 'print_sykt as sykt', 'print_title as title')->where('id', $id)->first();
        ...
        if($type == 4) {
          ...
          $list = DB::table('aset_present')->select('present_nama as nama', 'present_sykt as sykt', 'present_title as title')->where('id', $id)->first();
